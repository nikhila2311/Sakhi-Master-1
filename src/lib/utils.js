...
import { doc, getDoc, setDoc } from "firebase/firestore/lite"; // added setDoc import
...
export async function updateUser(email, userData) {
  try {
    ...
    await setDoc(userRef, userData, { merge: true }); // merge: true updates only provided fields
    return true;
  } catch (error) {
